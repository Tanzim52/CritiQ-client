...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    if (!passwordRegex.test(Password)) {
      setErrorMsg("Password must include at least one uppercase, one lowercase, one number, and one special character.");
      return;
    }
    ...
    try {
      ...
      const updatedUser = { ...result.user, photoURL: Photo, displayName: Name };
      setUser(updatedUser);
